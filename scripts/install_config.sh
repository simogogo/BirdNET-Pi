...
RAW_SPECTROGRAM=0
#-----------------  Long-duration False-color Spectrograms  -------------------#
## GENERATE_LDFCS_STANDARD and GENERATE_LDFCS_INDICES are for generating 
## 24-hour long-duration false-color spectrograms.
